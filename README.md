# Angular Sudoku Solver — Demo Application for Angular JS

This project is a sample application binding a sudoku engine to HTML.
...
Navigate your browser to `http://localhost:8000/sudoku.html` to see the app running in your browser.
